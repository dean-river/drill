#ifndef DRILL_COMMON_CMDLINE_H_
#define DRILL_COMMON_CMDLINE_H_
...
{
  return drill::common::detail::lexical_cast<std::string>(def);
}
...
struct default_reader{
  T operator()(const std::string &str){
    return drill::common::detail::lexical_cast<T>(str);
  }
};
...
struct range_reader{
  ...
  T operator()(const std::string &s) const {
    ...
    if (!(ret>=_low && ret<=_high)) throw cmdline_error("range_error");
    return ret;
  }
private:
  T _low, _high;
