#ifndef DRILL_EVENT_EVENTLOOP_H_
#define DRILL_EVENT_EVENTLOOP_H_
...
class EventLoop
{
 public:
  ...
  ///
  drill::common::Time pollReturnTime() const { return _pollReturnTime; }
  ...
  /// Safe to call from other threads.
  ///
  TimerId runAt(const drill::common::Time& time, const TimerCallback& cb);
  ///
  ...
  bool isInLoopThread() const { return _threadId == drill::localthread::tid(); }
 ...
 private:
  ...
  drill::common::Time        _pollReturnTime;
